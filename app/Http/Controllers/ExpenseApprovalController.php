...
class ExpenseApprovalController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $query = ProjectExpense::with(['project:id,title', 'budgetCategory:id,name,color', 'submitter:id,name,avatar,email'])
        ...
        $pendingExpenses->getCollection()->transform(function ($pendingExpense) {
            if ($pendingExpense->submitter) {
                $pendingExpense->submitter->avatar = check_file($pendingExpense->submitter->avatar)
                    ? get_file($pendingExpense->submitter->avatar)
