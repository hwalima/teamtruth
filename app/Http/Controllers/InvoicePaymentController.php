...
class InvoicePaymentController extends Controller
{
    public function show($token, Request $request)
    {
        ...
        $ownerId = $invoice->workspace->owner_id;


        // Get company information
        $company = \App\Models\User::where('id', $ownerId)
            ->where('type', 'company')
            ->select('id', 'name', 'email')
            ->first();
            
        // Get favicon and app name from settings table
        $settings = \App\Models\Setting::where('user_id', $ownerId)
        ...
        $enabledGateways = $this->getEnabledPaymentGateways($ownerId, $invoice->workspace_id);

        $paymentSettings = PaymentSetting::where('user_id', $ownerId)
        ...
        $invoiceSettings = \App\Models\Setting::where('user_id', $ownerId)
    ...
    {
        $ownerId = $invoice->workspace->owner_id;
        $gateways = $this->getEnabledPaymentGateways($ownerId, $invoice->workspace_id);
