...
class BugController extends Controller
{
    ...
    public function show(Bug $bug)
    {
        ...
        if ($bug->reportedBy) {
            $bug->reportedBy->avatar = check_file($bug->reportedBy->avatar)
                ? get_file($bug->reportedBy->avatar)
                : get_file('avatars/avatar.png');
        }
        ...
        // Return JSON for AJAX requests (BugModal), Inertia page for direct visits
