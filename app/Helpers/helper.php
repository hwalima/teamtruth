...
if (! function_exists('settings')) {
    function settings($user_id = null, $workspace_id = null)
    {
        ...
        // Return from cache if this (user, workspace) combo was already fetched this request
        $cacheKey = ($user_id ?? 'null') . '_' . ($workspace_id ?? 'null');
        ...
        return $requestCache[$cacheKey] = $settings;
    }
}
