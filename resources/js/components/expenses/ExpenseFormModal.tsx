...
export default function ExpenseFormModal({ isOpen, onClose, expense, projects, mode, currentProject, redirectUrl }: Props) {
    ...
    useEffect(() => {
        if (mode === 'edit' && expense && isOpen) {
            ...
            setFormData({
                ...
                budget_category_id: expense.budget_category_id?.toString() || '',
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        if (!formData.task_id) newErrors.task_id = t('Task is required');
        ...
        if (mode === 'create') {
            ...
            if (redirectUrl) submitData['redirect_url'] = redirectUrl;
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                        ...
                        <Select
                            ...
                            disabled={!canEdit || !formData.project_id}
                        >
                            <SelectTrigger className={errors.task_id ? 'border-red-500' : ''}>
                                <SelectValue placeholder={!formData.project_id ? t('Select project first') : t('Select task')} />
                            </SelectTrigger>
                            <SelectContent searchable className="z-[60]">
                        ...
                        {errors.task_id && <p className="text-sm text-red-600 mt-1">{errors.task_id}</p>}
                    </div>
