                        ...
                        <div className="space-y-4">
                            <div className="p-4 rounded-lg border">
                                <div className="flex justify-between items-center">
                                    ...
                                    <span className="font-bold font-mono">{formatAmount(invoice.total_amount)}</span>
                                </div>
                                <div className="text-xs mt-1">{invoice.client?.name}</div>
                                <div className="text-xs mt-1 font-mono">Remaining: {formatAmount(remainingAmount)}</div>
                            </div>
