...
import { Paperclip, Download, MoreHorizontal, Trash2, File, Image, FileText, FileSpreadsheet, FileArchive, FileCode, Eye, Plus } from 'lucide-react';
                    ...
                    {attachments.length > 0 ? (
                        <div className="grid grid-cols-4 sm:grid-cols-5 md:grid-cols-6 lg:grid-cols-8 gap-3">
                            {attachments.map((attachment) => {
                                return (
                                    <div key={attachment.id} className="relative group border border-gray-300 dark:border-gray-700 rounded-xl overflow-hidden hover:shadow-md hover:border-gray-400 dark:hover:border-gray-600 transition-all bg-white dark:bg-gray-900">
                                        {/* Media Preview */}
                                            ...
                                            {attachment.media_item?.mime_type?.startsWith('image/') && attachment.media_item?.thumb_url ? (
                                                <div className="relative w-full h-full">
                                                    <img
                                                        ...
                                                        className="w-full h-full object-contain group-hover:opacity-70 transition-opacity"
                                                        onError={(e) => {
                                                    ...
                                                    <div
                                                        className="absolute inset-0 flex items-center justify-center gap-2 opacity-0 group-hover:opacity-100 transition-opacity bg-black/30"
