...
import { MessageSquare, MoreHorizontal, Edit, Trash2, Send, Calendar } from 'lucide-react';
    ...
    return (
        <>
            ...
            <div className="flex flex-col h-full overflow-hidden">
                                    ...
                                    <div className="flex items-center space-x-2">
                                        ...
                                        <div>
                                            ...
                                            <div className="flex items-center gap-1 text-[10px] text-gray-500 mt-1">
                                                ...
                                                <span>{window.appSettings.formatDateTime(new Date(comment.created_at))}</span>
                                            </div>
                                        </div>
                                    </div>
                ...
                {/* Add Comment Form */}
                {canAddComments && (
                    <div className="shrink-0 border-t pt-4 p-1">
