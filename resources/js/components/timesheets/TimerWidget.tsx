...
export default function TimerWidget({ projects, permissions }: Props) {
    ...
    }, [timerState.active, timerState.is_paused]);
        ...
        <Card className="w-full">
            <CardContent className="p-4">
                <div className="flex items-center gap-2 mb-4">
                    ...
                    <span className="font-semibold">{t('Timer')}</span>
                    ...
                    <div className="grid grid-cols-5 gap-3 items-end">
                        <div>
                            <Select value={selectedProject} onValueChange={setSelectedProject}>
                                <SelectTrigger>
                                    <SelectValue placeholder={<span>{t('Select project')} <span className="text-red-500">*</span></span>} />
                                </SelectTrigger>
                                <SelectContent>
                        ...
                        <div>
                            <Select value={selectedTask} onValueChange={setSelectedTask}>
                                <SelectTrigger>
                                    <SelectValue placeholder={<span>{t('Select task')} <span className="text-red-500">*</span></span>} />
                                </SelectTrigger>
                                <SelectContent>
