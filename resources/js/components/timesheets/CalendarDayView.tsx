                ...
                <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-3 gap-4">
                        <div className="bg-blue-50 p-3 rounded-lg text-center">
                            <div className="text-xl font-bold text-blue-900">{getTotalHours().toFixed(1)}h</div>
                            <div className="text-sm text-blue-600">Total</div>
                        </div>
                        <div className="bg-green-50 p-3 rounded-lg text-center">
                            <div className="text-xl font-bold text-green-900">{getBillableHours().toFixed(1)}h</div>
                            <div className="text-sm text-green-600">Billable</div>
                        </div>
                        <div className="bg-purple-50 p-3 rounded-lg text-center">
                            <div className="text-xl font-bold text-purple-900">{entries.length}</div>
