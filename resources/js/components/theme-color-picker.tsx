        ...
        <div className="space-y-4">
            ...
            <div className="flex flex-wrap gap-3">
                {Object.entries(THEME_COLORS).map(([name, hex]) => (
                    <button
                        ...
                        className={cn(
                            'relative cursor-pointer h-8 w-8 rounded-full transition-all',
            ...
            {themeColor === 'custom' && (
                <div className="flex items-center gap-2">
                    ...
                    <button
                        onClick={handleCustomColorClick}
                        className="rounded cursor-pointer bg-neutral-100 px-2 py-1 text-xs hover:bg-neutral-200 dark:bg-neutral-800 dark:hover:bg-neutral-700"
                    >
                        {t("Change")}
                    </button>
                </div>
