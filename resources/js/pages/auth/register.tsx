            ...
            <form className="space-y-5" onSubmit={submit}>
                <div className="space-y-4">
                    <div className="relative">
                        <Label required htmlFor="name" className="text-gray-700 dark:text-gray-300 font-medium mb-2 block">{t("Full name")}</Label>
                        <div className="relative">
                            <Input
                                id="name"
                                type="text"
                    ...
                    <div>
                        <Label required htmlFor="password" className="text-gray-700 dark:text-gray-300 font-medium mb-2 block">{t("Password")}</Label>
                        <div className="relative">
                            <Input
                                id="password"
                                type="password"
                    ...
                    <div>
                        <Label required htmlFor="password_confirmation" className="text-gray-700 dark:text-gray-300 font-medium mb-2 block">{t("Confirm password")}</Label>
                        <div className="relative">
                            <Input
