...
export default function InvoiceForm({ invoice, projects, clients, currencies, taxes }: Props) {
    ...
    return (
        <PageTemplate
            ...
            description={t('Manage an invoice by selecting a project, client, and updating the associated tasks and amounts.')}
                                            ...
                                            <tr key={index} className="hover:bg-muted/20 transition-colors">
                                                ...
                                                <td className="px-4 py-3 align-middle">
                                                    <Button
                                                        ...
                                                        className="text-gray-500 hover:text-gray-700 hover:bg-gray-50 h-8 w-8"
                                                    >
                            ...
                            <div className="w-72 border rounded-lg overflow-hidden">
                                ...
                                <div className="px-4 py-3 space-y-2">
                                    ...
                                    {formData.selected_taxes.length > 0 && formData.selected_taxes.map((taxId: number) => {
                                        ...
                                        return (
                                            <div key={taxId} className="flex justify-between text-sm">
                                                ...
                                                <span className="font-medium font-mono">{formatCurrency(taxAmount)}</span>
                                            </div>
                                        );
                                    })}
                                    <Separator />
                                    <div className="flex justify-between items-center pt-1">
                                        ...
                                        <span className="font-bold text-lg font-mono">{formatCurrency(calculateTotal())}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
