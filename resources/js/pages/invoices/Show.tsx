        ...
        <>
            ...
            <div className="print:hidden">
                <PageTemplate
                    ...
                    description={t('View the details of this invoice and manage its payment status.')}
                                ...
                                <div className="mt-6 flex justify-end">
                                    <div className="w-full max-w-sm space-y-3 bg-muted/50 rounded-lg p-5 shadow-sm border border-muted/50">
                                        ...
                                        <div className="flex justify-between">
                                            ...
                                            <span className="font-bold text-base tracking-tight font-mono">{formatCurrency(invoice.total_amount)}</span>
                                        </div>
                                        {invoice.paid_amount > 0 && (
                                            <div className="flex justify-between text-base">
                                                <span className="text-muted-foreground font-semibold">{t('Paid Amount')}</span>
                                                <span className="font-bold text-green-600 font-mono">{formatCurrency(invoice.paid_amount)}</span>
                                            </div>
                                        )}
                                        <div className="flex justify-between">
                                            ...
                                            <tbody className="divide-y divide-border">
                                                {pendingPayments.map((payment) => (
                                                    <tr key={payment.id}>
                                                        ...
                                                        <td className="px-3 py-2 font-bold text-sm font-mono">
