...
export default function ContractTypesIndex() {
    ...
    return (
        <PageTemplate
            title={t('Contract Types')}
            description={t('Manage and track your client contract types.')}
            url="/contract-types"
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
                        {(contractTypes?.data || []).length > 0 ? (
                            <>
                                        ...
                                        <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                            <thead>
                                                <tr className="bg-[#F0F0F1] dark:bg-gray-900 border-t">
                                                    ...
                                                    <th className="pr-[50px] px-4 py-3 text-right text-xs font-medium text-gray-500 dark:text-gray-300 tracking-wider">
                                                        {t('Actions')}
                                                    </th>
                                                </tr>
                                            </thead>
                                                            ...
                                                            <div className="flex items-center justify-end space-x-2">
                                                                ...
                                                                {canEdit && (
                                                                    <Button
                                                                        ...
                                                                        className={`h-8 w-8 p-0 ${item.is_active ? 'text-gray-500' : 'text-gray-600'}`}
                                        ...
                                        >
                                            <div className="flex items-start justify-between mb-3">
                                                ...
                                                <div className="flex items-center space-x-1">
                                                    ...
                                                    {canEdit && (
                                                        <Button variant="ghost" size="sm" onClick={() => handleAction('toggle-status', item)} className={`h-8 w-8 p-0 ${item.is_active ? 'text-gray-500' : 'text-gray-600'}`}>
                                                            <Lock className="h-4 w-4" />
                                                        </Button>
                                                    )}
                                                    {canDelete && (
                                                        <Button variant="ghost" size="sm" onClick={() => handleAction('delete', item)} className="h-8 w-8 p-0 text-gray-500" disabled={item.contracts_count > 0}>
                                                            <Trash2 className="h-4 w-4" />
                                                        </Button>
                                                    )}
                                                </div>
                                ...
                                {/* Pagination */}
                                {contractTypes?.total > (contractTypes?.per_page || 10) && (
                                    <Pagination
