...
import { ChevronLeft, ChevronRight, Plus, Clock, Calendar, TrendingUp, BarChart3 } from 'lucide-react';
...
export default function MonthlyView({ 
    ...
    return (
        <PageTemplate 
            title={t('Monthly View')}
            description={t('View your timesheets for the selected month and view summaries of your time entries.')} 
            actions={pageActions}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                <Card className="relative bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 overflow-hidden hover:shadow-lg transition-all duration-300">
                    ...
                    <CardContent className="relative p-5">
                        <div className="flex items-start justify-between">
                            <div>
                                <p className="text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">{t('Total Hours')}</p>
                                <p className="text-2xl font-bold text-gray-900 dark:text-white">{monthData.total_hours.toFixed(1)}h</p>
                                <p className="text-xs text-gray-400 dark:text-gray-500 mt-1">{getAverageHoursPerDay()}h avg/day</p>
                            </div>
                ...
                <Card className="relative bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 overflow-hidden hover:shadow-lg transition-all duration-300">
                    ...
                    <CardContent className="relative p-5">
                        <div className="flex items-start justify-between">
                            <div>
                                <p className="text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">{t('Billable Hours')}</p>
                                <p className="text-2xl font-bold text-gray-900 dark:text-white">{monthData.billable_hours.toFixed(1)}h</p>
                                <p className="text-xs text-gray-400 dark:text-gray-500 mt-1">{getBillablePercentage()}% of total</p>
                            </div>
                ...
                <Card className="relative bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 overflow-hidden hover:shadow-lg transition-all duration-300">
                    ...
                    <CardContent className="relative p-5">
                        <div className="flex items-start justify-between">
                            <div>
                                <p className="text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">{t('Entries')}</p>
                                <p className="text-2xl font-bold text-gray-900 dark:text-white">{monthData.entries_count}</p>
                                <p className="text-xs text-gray-400 dark:text-gray-500 mt-1">{monthData.working_days} working days</p>
                            </div>
                ...
                <Card className="relative bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 overflow-hidden hover:shadow-lg transition-all duration-300">
                    ...
                    <CardContent className="relative p-5">
                        <div className="flex items-start justify-between">
                            <div>
                                <p className="text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">{t('Utilization')}</p>
                                <p className="text-2xl font-bold text-gray-900 dark:text-white">{((monthData.total_hours / (monthData.working_days * 8)) * 100).toFixed(0)}%</p>
