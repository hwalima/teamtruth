...
export default function TimesheetReports({ members, projects, defaultFilters, defaultReportData, permissions }: Props) {
    ...
    return (
        <PageTemplate 
            title={t('Reports')}
            description={t('Generate and view timesheet reports.')} 
                                    ...
                                    <CardContent className="relative p-5">
                                        <div className="flex items-start justify-between">
                                            <div>
                                                ...
                                                <p className="text-2xl font-bold text-gray-900 dark:text-white">{parseFloat(reportData.summary?.total_hours || 0).toFixed(1)}h</p>
                                            </div>
                                    ...
                                    <CardContent className="relative p-5">
                                        <div className="flex items-start justify-between">
                                            <div>
                                                ...
                                                <p className="text-2xl font-bold text-gray-900 dark:text-white">{parseFloat(reportData.summary?.billable_hours || 0).toFixed(1)}h</p>
                                            </div>
                                    ...
                                    <CardContent className="relative p-5">
                                        <div className="flex items-start justify-between">
                                            <div>
                                                ...
                                                <p className="text-2xl font-bold text-gray-900 dark:text-white">{isDemoMode() ? formatCurrency(2000 + Math.random() * 5000) : formatCurrency(reportData.summary?.total_amount || 0)}</p>
                                            </div>
                                    ...
                                    <CardContent className="relative p-5">
                                        <div className="flex items-start justify-between">
                                            <div>
                                                ...
                                                <p className="text-2xl font-bold text-gray-900 dark:text-white">{reportData.summary?.entries_count || 0}</p>
                                            </div>
