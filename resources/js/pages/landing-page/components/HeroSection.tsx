        ...
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center">
          ...
          <div className="text-center lg:text-left space-y-6 sm:space-y-8">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 dark:text-white leading-tight" role="banner" aria-label="Main heading">
              {sectionData.title || (
                <>
                  {t('Streamline Your')} <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">{t("Team's Workflow")}</span> {t('with Taskly')}
                </>
              )}
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center lg:justify-start">
              {(pageProps.isSaas && isRegistrationEnabled()) && (
                <Link
                  href={route('register')}
                  className="px-8 py-4 rounded-xl transition-all duration-300 font-semibold text-base flex items-center justify-center gap-2 hover:scale-105 hover:shadow-lg transform"
