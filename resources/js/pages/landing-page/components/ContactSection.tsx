  ...
  const contactInfo = [
    {
      icon: Mail,
      title: t('Email Us'),
      content: settings?.contact_email || t('support@taskly.com'),
    },
    {
      icon: Phone,
      title: t('Call Us'),
    ...
    },
    {
      icon: MapPin,
      title: t('Visit Us'),
      content: settings?.contact_address || t('123 Business Ave, Suite 100'),
    }
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-6" role="form" aria-label="Contact form">
                ...
                <button
                  type="submit"
                  disabled={processing}
                  className="w-full text-white px-8 py-4 rounded-lg cursor-pointer transition-colors font-semibold disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
